...
$countSelected = 0;
$countQuery = $conn->query("SELECT COUNT(*) AS total FROM quiz WHERE course='bsaben' AND checkQuestion='selected'");
...
if (!empty($search)) {
  $stmt = $conn->prepare("SELECT * FROM quiz WHERE subject_name = ? AND course = 'bsaben'");
...
<div class="container">
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form id="filter-form-question-bsaben" class="d-flex gap-2 mb-3">
        ...
        <a href="questioner_bsaben.php" id="reset-filter-question-bsaben"
      ...
      <?php if ($result && $result->num_rows > 0): ?>
        <form id="markSelectedForm2">
          ...
          <button type="button" class="btn btn-danger mt-2" id="unmarkSelectedBtn2">Unmark Selected</button>
        </form>
      <?php else: ?>
...
<div class="modal fade" id="editQuizModal2" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form id="EditQuizForm2">
