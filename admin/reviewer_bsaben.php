              ...
              <div class="modal-body">
                <select class="form-select" name="subject_name" required>
                  ...
                  <optgroup label="AB POWER ENERGY AND MACHINE ENGINEERING AND ALLIDE SUBJECTS">
                    ...
                    <option value="Area 1: Agricultural and Biosystems Machinery Specifications, Testing and Evaluation">
                  ...
                  <optgroup label="LAND AND WATER RESOURCES ENGINEERING AND ALLIED SUBJECTS">
                    ...
                    <option value="Area 2: Fundamentals of Agricultural, Fishery, Ecological and Environmental Sciences">
                  ...
                  <optgroup label="AB STRUCTURE AND ENVIRONMENT ENGINEERING AND BIO PROCESS ENGINEERING AND ALLIED SUBJECTS">
          ...
          while ($r = $res->fetch_assoc()) {
            echo '<div class="col-sm-6 mb-3">
              <div class="card">
                ...
                <a class="btn btn-primary archive-subject me-2" data-subject="' . htmlspecialchars($r['subject_name']) . '">
